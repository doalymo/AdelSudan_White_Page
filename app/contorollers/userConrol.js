...
angular
.module('app')
.controller('userControl', Controller);
...
var userName,passward = $stateParams.userName& $stateParams.passward;
userService.getUser(userName,passward).then(function(res) {
$scope.user = res.data;
}).catch(function(err) {
console.log(err);
});
